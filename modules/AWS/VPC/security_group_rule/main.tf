...
//  source_security_group_id = lookup(var.security_group_rule[count.index], "cidr_blocks") == "" ? element(var.source_security_group_id, lookup(var.security_group_rule[count.index], "source_security_group_id")) : ""
}