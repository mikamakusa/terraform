...
resource "aws_route_table" "aws_route_table" {
  ...
  route  = lookup(aws_route_table[count.index], "route")
}
...
resource "aws_route" "aws_route" {
  ...
  vpc_peering_connection_id = lookup(var.route[count.index],"vpc_peering_connection_id")
}