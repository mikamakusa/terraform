...
resource "azurerm_linux_function_app_slot" "this" {
  ...
  app_settings                                   = lookup(var.linux_function_app_slot[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.linux_function_app_slot[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.linux_function_app_slot[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.linux_function_app_slot[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.linux_function_app_slot[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.linux_function_app_slot[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.linux_function_app_slot[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.linux_function_app_slot[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.linux_function_app_slot[count.index], "functions_extension_version")
  https_only                                     = lookup(var.linux_function_app_slot[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.linux_function_app_slot[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.linux_function_app_slot[count.index], "key_vault_reference_identity_id")
  service_plan_id                                = lookup(var.linux_function_app_slot[count.index], "service_plan_id")
  storage_account_access_key                     = lookup(var.linux_function_app_slot[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.linux_function_app_slot[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.linux_function_app_slot[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.linux_function_app_slot[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.linux_function_app_slot[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.linux_function_app_slot[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.linux_function_app_slot[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.linux_function_app_slot[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.linux_function_app_slot[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.linux_function_app_slot[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.linux_function_app_slot[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.linux_function_app_slot[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.linux_function_app_slot[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.linux_function_app_slot[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
...
resource "azurerm_linux_web_app" "this" {
  count = length(var.linux_web_app) == "0" ? "0" : length(var.service_plan)
  location = try(
  ...
  app_settings                                   = lookup(var.linux_web_app[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.linux_web_app[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.linux_web_app[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.linux_web_app[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.linux_web_app[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.linux_web_app[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.linux_web_app[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.linux_web_app[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.linux_web_app[count.index], "functions_extension_version")
  https_only                                     = lookup(var.linux_web_app[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.linux_web_app[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.linux_web_app[count.index], "key_vault_reference_identity_id")
  storage_account_access_key                     = lookup(var.linux_web_app[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.linux_web_app[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.linux_web_app[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.linux_web_app[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.linux_web_app[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.linux_web_app[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.linux_web_app[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.linux_web_app[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.linux_web_app[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.linux_web_app[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.linux_web_app[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.linux_web_app[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.linux_web_app[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.linux_web_app[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
  ...
  dynamic "sticky_settings" {
    for_each = lookup(var.linux_web_app[count.index], "sticky_settings") == null ? [] : ["sticky_settings"]
    content {
      app_setting_names       = lookup(sticky_settings.value, "app_setting_names")
      connection_string_names = lookup(sticky_settings.value, "connection_string_names")
    }
...
resource "azurerm_linux_web_app_slot" "this" {
  ...
  app_settings                                   = lookup(var.linux_web_app_slot[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.linux_web_app_slot[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.linux_web_app_slot[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.linux_web_app_slot[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.linux_web_app_slot[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.linux_web_app_slot[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.linux_web_app_slot[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.linux_web_app_slot[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.linux_web_app_slot[count.index], "functions_extension_version")
  https_only                                     = lookup(var.linux_web_app_slot[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.linux_web_app_slot[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.linux_web_app_slot[count.index], "key_vault_reference_identity_id")
  storage_account_access_key                     = lookup(var.linux_web_app_slot[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.linux_web_app_slot[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.linux_web_app_slot[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.linux_web_app_slot[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.linux_web_app_slot[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.linux_web_app_slot[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.linux_web_app_slot[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.linux_web_app_slot[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.linux_web_app_slot[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.linux_web_app_slot[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.linux_web_app_slot[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.linux_web_app_slot[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.linux_web_app_slot[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.linux_web_app_slot[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
...
resource "azurerm_service_plan" "this" {
  ...
  app_service_environment_id   = lookup(var.service_plan[count.index], "app_service_environment_id")
  maximum_elastic_worker_count = lookup(var.service_plan[count.index], "maximum_elastic_worker_count")
  worker_count                 = lookup(var.service_plan[count.index], "worker_count")
  per_site_scaling_enabled     = lookup(var.service_plan[count.index], "per_site_scaling_enabled")
  zone_balancing_enabled       = lookup(var.service_plan[count.index], "zone_balancing_enabled")
  tags = merge(
    var.tags,
    lookup(var.service_plan[count.index], "tags")
  )
}
...
resource "azurerm_static_site" "this" {
  ...
  resource_group_name = data.azurerm_resource_group.this.name
  sku_tier            = lookup(var.static_site[count.index], "sku_tier")
  sku_size            = lookup(var.static_site[count.index], "sku_size")
  tags = merge(
    var.tags,
    lookup(var.static_site[count.index], "tags")
  )

  dynamic "identity" {
    for_each = lookup(var.static_site[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
...
resource "azurerm_web_app_active_slot" "this" {
  ...
  overwrite_network_config = lookup(var.web_app_active_slot[count.index], "overwrite_network_config")
}
...
resource "azurerm_web_app_hybrid_connection" "this" {
  ...
  send_key_name = lookup(var.web_app_hybrid_connection[count.index], "send_key_name")
}
...
resource "azurerm_windows_function_app" "this" {
  ...
  app_settings                                   = lookup(var.windows_function_app[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.windows_function_app[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.windows_function_app[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.windows_function_app[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.windows_function_app[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.windows_function_app[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.windows_function_app[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.windows_function_app[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.windows_function_app[count.index], "functions_extension_version")
  https_only                                     = lookup(var.windows_function_app[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.windows_function_app[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.windows_function_app[count.index], "key_vault_reference_identity_id")
  storage_account_access_key                     = lookup(var.windows_function_app[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.windows_function_app[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.windows_function_app[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.windows_function_app[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.windows_function_app[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.windows_function_app[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.windows_function_app[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.windows_function_app[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.windows_function_app[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.windows_function_app[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.windows_function_app[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.windows_function_app[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.windows_function_app[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.windows_function_app[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
  ...
  dynamic "sticky_settings" {
    for_each = lookup(var.windows_function_app[count.index], "sticky_settings") == null ? [] : ["sticky_settings"]
    content {
      app_setting_names       = lookup(sticky_settings.value, "app_setting_names")
      connection_string_names = lookup(sticky_settings.value, "connection_string_names")
    }
...
resource "azurerm_windows_function_app_slot" "this" {
  ...
  app_settings                                   = lookup(var.windows_function_app_slot[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.windows_function_app_slot[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.windows_function_app_slot[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.windows_function_app_slot[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.windows_function_app_slot[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.windows_function_app_slot[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.windows_function_app_slot[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.windows_function_app_slot[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.windows_function_app_slot[count.index], "functions_extension_version")
  https_only                                     = lookup(var.windows_function_app_slot[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.windows_function_app_slot[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.windows_function_app_slot[count.index], "key_vault_reference_identity_id")
  storage_account_access_key                     = lookup(var.windows_function_app_slot[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.windows_function_app_slot[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.windows_function_app_slot[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.windows_function_app_slot[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.windows_function_app_slot[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.windows_function_app_slot[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.windows_function_app_slot[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.windows_function_app_slot[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.windows_function_app_slot[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.windows_function_app_slot[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.windows_function_app_slot[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.windows_function_app_slot[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.windows_function_app_slot[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.windows_function_app_slot[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
  ...
  dynamic "sticky_settings" {
    for_each = lookup(var.windows_function_app_slot[count.index], "sticky_settings") == null ? [] : ["sticky_settings"]
    content {
      app_setting_names       = lookup(sticky_settings.value, "app_setting_names")
      connection_string_names = lookup(sticky_settings.value, "connection_string_names")
    }
...
resource "azurerm_windows_web_app" "this" {
  ...
  app_settings                                   = lookup(var.windows_function_app_slot[count.index], "app_settings")
  client_certificate_mode                        = lookup(var.windows_web_app[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.windows_web_app[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.windows_web_app[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.windows_web_app[count.index], "daily_memory_time_quota")
  enabled                                        = lookup(var.windows_web_app[count.index], "enabled")
  ftp_publish_basic_authentication_enabled       = lookup(var.windows_web_app[count.index], "ftp_publish_basic_authentication_enabled")
  functions_extension_version                    = lookup(var.windows_web_app[count.index], "functions_extension_version")
  https_only                                     = lookup(var.windows_web_app[count.index], "https_only")
  public_network_access_enabled                  = lookup(var.windows_web_app[count.index], "public_network_access_enabled")
  key_vault_reference_identity_id                = lookup(var.windows_web_app[count.index], "key_vault_reference_identity_id")
  storage_account_access_key                     = lookup(var.windows_web_app[count.index], "storage_account_access_key")
  storage_account_name                           = lookup(var.windows_web_app[count.index], "storage_account_name")
  storage_uses_managed_identity                  = lookup(var.windows_web_app[count.index], "storage_uses_managed_identity")
  storage_key_vault_secret_id                    = lookup(var.windows_web_app[count.index], "storage_key_vault_secret_id")
  tags                                           = lookup(var.windows_web_app[count.index], "tags")
  virtual_network_subnet_id                      = lookup(var.windows_web_app[count.index], "virtual_network_subnet_id")
  webdeploy_publish_basic_authentication_enabled = lookup(var.windows_web_app[count.index], "webdeploy_publish_basic_authentication_enabled")

  dynamic "site_config" {
    for_each = lookup(var.windows_web_app[count.index], "site_config")
    content {
      always_on                                     = lookup(site_config.value, "always_on")
      container_registry_use_managed_identity       = lookup(site_config.value, "container_registry_use_managed_identity")
      http2_enabled                                 = lookup(site_config.value, "http2_enabled")
  ...
  dynamic "auth_settings" {
    for_each = lookup(var.windows_web_app[count.index], "auth_settings") == null ? [] : ["auth_settings"]
    content {
      enabled                        = false
      additional_login_parameters    = lookup(auth_settings.value, "additional_login_parameters")
      allowed_external_redirect_urls = lookup(auth_settings.value, "allowed_external_redirect_urls")
  ...
  dynamic "auth_settings_v2" {
    for_each = lookup(var.windows_web_app[count.index], "auth_settings_v2") == null ? [] : ["auth_settings_v2"]
    content {
      auth_enabled                            = lookup(auth_settings_v2.value, "auth_enabled")
      require_authentication                  = lookup(auth_settings_v2.value, "require_authentication")
      require_https                           = lookup(auth_settings_v2.value, "require_https")
  ...
  dynamic "backup" {
    for_each = lookup(var.windows_web_app[count.index], "backup") == null ? [] : ["backup"]
    content {
      name                = lookup(backup.value, "name")
      storage_account_url = lookup(backup.value, "storage_account_url")
      enabled             = lookup(backup.value, "enabled")
  ...
  dynamic "connection_string" {
    for_each = lookup(var.windows_web_app[count.index], "connection_string") == null ? [] : ["connection_string"]
    content {
      name  = lookup(connection_string.value, "name")
      type  = lookup(connection_string.value, "type")
      value = lookup(connection_string.value, "value")
  ...
  dynamic "identity" {
    for_each = lookup(var.windows_web_app[count.index], "identity") == null ? [] : ["identity"]
    content {
      type         = lookup(identity.value, "type")
      identity_ids = lookup(identity.value, "identity_ids")
    }
  ...
  dynamic "storage_account" {
    for_each = lookup(var.windows_web_app[count.index], "storage_account") == null ? [] : ["storage_account"]
    content {
      access_key   = lookup(storage_account.value, "access_key")
      account_name = lookup(storage_account.value, "account_name")
      name         = lookup(storage_account.value, "name")
  ...
  dynamic "sticky_settings" {
    for_each = lookup(var.windows_web_app[count.index], "sticky_settings") == null ? [] : ["sticky_settings"]
    content {
      app_setting_names       = lookup(sticky_settings.value, "app_setting_names")
      connection_string_names = lookup(sticky_settings.value, "connection_string_names")
    }
...
resource "azurerm_windows_web_app_slot" "this" {
  ...
  name = lookup(var.windows_function_app_slot[count.index], "name")
  app_settings                                   = lookup(var.windows_web_app[count.index], "app_settings")
  builtin_logging_enabled                        = lookup(var.windows_web_app[count.index], "builtin_logging_enabled")
  client_certificate_mode                        = lookup(var.windows_web_app[count.index], "client_certificate_mode")
  client_certificate_exclusion_paths             = lookup(var.windows_web_app[count.index], "client_certificate_exclusion_paths")
  content_share_force_disabled                   = lookup(var.windows_web_app[count.index], "content_share_force_disabled")
  daily_memory_time_quota                        = lookup(var.windows_web_app[count.index], "daily_memory_time_quota")
