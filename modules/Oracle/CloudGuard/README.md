...
|------|-------------|------|---------|:--------:|
| <a name="input_cloud_guard_configuration"></a> [cloud\_guard\_configuration](#input\_cloud\_guard\_configuration) | This resource provides the Cloud Guard Configuration resource in Oracle Cloud Infrastructure Cloud Guard service. | <pre>list(map(object({<br>    id                    = number<br>    reporting_region      = string<br>    status                = string<br>    self_manage_resources = optional(bool)<br>  })))</pre> | `[]` | no |
